...
public static class TableConsts
{
    ...
    public const string IdentityPolicies = "Policies";
    public const string IdentityUserPolicies = "UserPolicies";
    public const string IdentityRolePolicies = "RolePolicies";
}